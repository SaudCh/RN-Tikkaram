        ...
        <View style={{ ...styles.container }}>
            ...
            <View style={{ ...styles.restaurantContainer }}>
                ...
                <View>
                    ...
                    <Text style={{ fontSize: 16, color: "#9E9E9E", fontFamily: "arabicRegular" }}>5.3km</Text>
                    <Text style={{ fontSize: 16, color: "#A6A6A6", fontFamily: "arabicRegular" }}>+962 79 999 9999</Text>
                </View>
                <View>
